...
type State = {
  ...
  cornerstoneDivLayer: HTMLDivElement | null;
};

type Action = {
  setSingleViewPortStack: (singleViewPortStack: Types.IStackViewport) => void;
  setCornerstoneDiveLayer: (div: HTMLDivElement) => void;
};
...
const useDicomEditorStore = create<State & Action>((set) => ({
  ...
  toolGroupId:
    "toolGroupId:::wadouri:https://nhanmt.s3.ap-northeast-1.amazonaws.com/I0000000",
  ...
  cornerstoneDivLayer: null,

  setCornerstoneDiveLayer: (div: HTMLDivElement) =>
    set(() => ({
      cornerstoneDivLayer: div,
    })),
